    ...
    <div class="order-confirmation-view">
        <div class="container mx-auto px-4 py-8">
            ...
            <div v-else-if="order" class="max-w-2xl mx-auto text-center">
                ...
                <p class="text-xl text-gray-600 mb-8">Thank you for your order, {{ order.customerInfo?.name ||
                    'Customer' }}!</p>
                ...
                <div class="card p-6 text-left mb-8">
                    ...
                    <div class="space-y-4">
                        ...
                        <div v-if="order.orderType === 'delivery' && order.deliveryAddress"
                        ...
                        <div class="border-t pt-4">
                            ...
                            <div class="space-y-2">
                                <div v-for="item in order.items" :key="item.cartItemId"
                                    ...
                                    <span class="text-gray-600">{{ formatCurrency(item.basePrice * item.quantity)
                                        }}</span>
                                </div>
                            </div>
                        </div>
                ...
                <div class="flex flex-col sm:flex-row gap-4 justify-center">
                    <BaseButton variant="primary" @click="router.push('/menu')">
                        Order More 🍕
                    </BaseButton>
...
onMounted(async () => {
    try {
        ...
        // First check if we have the order in the store (just placed)
